    ...
    $("#tempDO_Container").append(`
        <div class="card">
            <div class="card-header">
                <a data-toggle="collapse" href="#collapse-doTemp${tempDOCount}" aria-expanded="true" aria-controls="collapse-doTemp${tempDOCount}" id="heading-example" class="d-block text-center">
...
$("#addSecchi").click(function() { //Add a secchi card to the secchi container
    ...
    $("#secchiDepth_Container").append(`
            <div class="card">
                <div class="card-header">
                    <a data-toggle="collapse" href="#collapse-secchi${secchiCount}" aria-expanded="true" aria-controls="collapse-secchi${secchiCount}" id="heading-example" class="d-block text-center">
                        <i class="fa fa-chevron-down pull-right"></i>
                        Secchi ${secchiCount}
                    </a>
                </div>
...
$("#addPhosphorus").click(function() { //Add a phosphorus card to the phosphorus container
    ...
    $("#phosphorus_Container").append(`
            <div class="card">
                <div class="card-header">
                    <a data-toggle="collapse" href="#collapse-phosphorus${phosphorusCount}" aria-expanded="true" aria-controls="collapse-phosphorus${phosphorusCount}" id="heading-example" class="d-block text-center">
                        <i class="fa fa-chevron-down pull-right"></i>
...
$("#addCalcium").click(function() { //Add a calcium card to the calcium container
    ...
    $("#calcium_Container").append(`
            <div class="card">
                <div class="card-header">
                    <a data-toggle="collapse" href="#collapse-calcium${calciumCount}" aria-expanded="true" aria-controls="collapse-calcium${calciumCount}" id="heading-example" class="d-block text-center">
                        <i class="fa fa-chevron-down pull-right"></i>
